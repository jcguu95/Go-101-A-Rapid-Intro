...
this balance is a high-level skill, and even the best players or the fastest
...
In the previous section, we explored some sample games. To truly enjoy Go, it
is essential to avoid fundamental mistakes. But what counts as "fundamental"?
This guide defines it for you: if you can steer clear of the mistakes outlined
in this section, I guarantee you will begin to appreciate the profound depth
and beauty of Go.
