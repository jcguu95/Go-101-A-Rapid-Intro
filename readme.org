...
If the first eye is big enough, then you don't have to make/break the second
eye. However, if it's reduced to small spaces like the followings, then you
need to make/break the second eye at the marked points. It is very important
to verify these by yourself a few times in your life.
