...
In the previous section, we looked at sample games and saw how a lack of
fundamental skills can prevent your plans from succeeding. When your plan
unfolds as intended, the game becomes much more enjoyable. So, to fully
appreciate Go, it's essential to avoid fundamental mistakes. But what
qualifies as "fundamental"? This guide defines it for you: if you can master
the knowledge points in this section, you will be able to make longer, more
masterful plans, and experience the profound depth and beauty of Go.
